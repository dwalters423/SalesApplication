...
//    for Reston Real Estate company. This file- Customers.aspx.cs is the 'CodeBehind' page that allows functions to be called
...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void CustFormView_ItemDeleted(object sender, FormViewDeletedEventArgs e)
    {
        CustomersView.DataBind();
    }
    ...
    protected void NewRecordButton_Click(object sender, EventArgs e)
    {
        ...
        CustFormView.ChangeMode(FormViewMode.Insert);
    }
}